...
function getUsage() {
  ...
  const data = JSON.parse(localStorage.getItem("rh_usage") || "{}");
      ...
      {stars.map((s) => (
        <div
          ...
          style={{
            ...
            background: "white",
            opacity: s.op,
            animation: `tw ${s.dur}s ${s.delay}s ease-in-out infinite`,
          }}
        />
      ))}
    </div>
...
function formatBody(text) {
  return (text || "").replace(
    /\*\*(.*?)\*\*/g,
    '<strong style="color:#FFD166;font-weight:500">$1</strong>',
  );
}
...
export default function Home() {
  ...
  const [fallsLeft, setFallsLeft] = useState(DAILY_LIMIT);

  useEffect(() => {
    setFallsLeft(fallsRemaining());
  }, [screen]);
  ...
  async function fall(suggested) {
    ...
    if (fallsRemaining() <= 0) {
      setErr(
        "You've used your 3 free rabbit holes today 🕳️ Come back tomorrow for more!",
      );
      return;
    }
    ...
    try {
      ...
      recordFall(); // ← record AFTER success
      setFallsLeft(fallsRemaining()); // ← update display
      setResult(data);
      setCount((c) => c + 1);
      setScreen("journey");
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Type any topic. Fall through 5 mind-blowing connected facts. The curiosity engine that beats scrolling."
        />
        <meta property="og:title" content="The Rabbit Hole 🕳️" />
        <meta
          property="og:description"
          content="Stop scrolling. Start falling. Type anything — get 5 mind-blowing connected facts instantly."
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link
          href="https://fonts.googleapis.com/css2?family=Syne:wght@400;700;800;900&family=Lora:ital,wght@0,300;0,400;1,300;1,400&display=swap"
          rel="stylesheet"
        />
        <script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5075202378305514"
      ...
      >
        ...
        >
          ...
          {screen === "home" && (
            <div className="fu" style={{ paddingTop: 64, paddingBottom: 64 }}>
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "radial-gradient(circle at 35% 35%,#7B4FFF,#050508)",
                ...
                <span
                  style={{
                    ...
                    fontWeight: 800,
                    letterSpacing: 3,
                    ...G("linear-gradient(135deg,#7B4FFF,#FF4F9B)"),
                  }}
                >
                  THE RABBIT HOLE
                </span>
              ...
              <div style={{ textAlign: "center", marginBottom: 48 }}>
                ...
                >
                  <span style={{ display: "block", color: "#E8E8F0" }}>
                    Stop scrolling.
                  </span>
                  <span
                    style={{
                      display: "block",
                      ...G("linear-gradient(135deg,#7B4FFF,#FF4F9B,#FFD166)"),
                    }}
                  >
                    Start falling.
                  </span>
                ...
                >
                  Type <em>anything</em> you're curious about. Fall through 5
                  mind-blowing connected facts. Guaranteed to make you say "wait
                  — WHAT?!"
                </p>
              </div>
              ...
              >
                <span style={{ fontSize: 22, marginRight: 10, flexShrink: 0 }}>
                  🕳️
                </span>
                <input
                  ref={inputRef}
                ...
                <button
                  ...
                  style={{
                    ...
                    background: inputVal.trim()
                      ? "linear-gradient(135deg,#7B4FFF,#FF4F9B)"
                      : "rgba(100,80,160,.25)",
                    border: "none",
                    borderRadius: 14,
                    fontFamily: "'Syne',sans-serif",
              ...
              {err && (
                <div
                  style={{
                    marginBottom: 16,
                    padding: "12px 18px",
                    background: "rgba(255,79,155,.1)",
                    border: "1px solid rgba(255,79,155,.25)",
                    borderRadius: 12,
                    color: "#FF9FBB",
                    fontSize: 14,
                    lineHeight: 1.6,
              ...
              {fallsLeft < DAILY_LIMIT && fallsLeft > 0 && (
                <p
                  style={{
                    textAlign: "center",
                    fontSize: 13,
                ...
                >
                  {fallsLeft} free fall{fallsLeft !== 1 ? "s" : ""} remaining
                  today
                </p>
              )}
              {/* Suggestions */}
              ...
              >
                {[
                  ["∞", "topics — type anything"],
                  ["5", "stops per rabbit hole"],
                  ["0", "boring facts ever"],
                ].map(([n, l]) => (
                  <div key={l} style={{ textAlign: "center" }}>
                    <span
                      style={{
                        ...
                        fontWeight: 900,
                        display: "block",
                        ...G("linear-gradient(135deg,#4FFFCB,#7B4FFF)"),
                      }}
                    >
                      {n}
                    </span>
          ...
          {screen === "loading" && (
            <div
              className="fu"
              style={{ textAlign: "center", padding: "110px 0" }}
            >
              <div
                style={{
                  position: "relative",
              ...
              >
                {[
                  { i: 0, c: "#7B4FFF", d: "1.5s", r: "" },
                  { i: 12, c: "#FF4F9B", d: "2s", r: "reverse" },
                  { i: 24, c: "#4FFFCB", d: "2.5s", r: "" },
                ].map((x, k) => (
                  <div
                    key={k}
                    style={{
                      ...
                      borderTopColor: x.c,
                      animation: `spin ${x.d} linear infinite ${x.r}`,
                    }}
                  />
                ))}
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "radial-gradient(circle,#7B4FFF 0%,#050508 70%)",
          ...
          {screen === "journey" && result && (
            <div style={{ paddingTop: 44, paddingBottom: 64 }}>
              ...
              >
                ...
                >
                  Starting with:{" "}
                  <span style={G("linear-gradient(135deg,#7B4FFF,#FF4F9B)")}>
                    {result.topic}
                  </span>
                </h2>
                <p
                ...
                <div key={i}>
                  <div
                    style={{
                      ...
                      transition: `opacity .5s ease ${i * 0.11}s, transform .5s ease ${i * 0.11}s`,
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Stop {i + 1} of {result.stops.length}
                      </span>
                    </div>
                    <h3
                      style={{
                    ...
                    <p
                      style={{
                        ...
                        fontWeight: 300,
                        marginBottom: stop.wow ? 14 : 0,
                      }}
                      dangerouslySetInnerHTML={{
                        __html: formatBody(stop.body),
                      }}
                    />
                    {stop.wow && (
                      <div
                  ...
                  {i < result.stops.length - 1 && (
                    <div
                      style={{
                        ...
                        margin: "2px 0",
                        opacity: shown ? 1 : 0,
                        transition: `opacity .35s ease ${i * 0.11 + 0.05}s`,
                      }}
                    >
                      <div
                        style={{
                          ...
                          height: 14,
                          background:
                            "linear-gradient(to bottom,rgba(123,79,255,.45),rgba(255,79,155,.45))",
                        }}
                      />
                      <div
                        style={{
                          ...
                          borderRadius: "50%",
                          background: "#7B4FFF",
                          boxShadow: "0 0 7px rgba(123,79,255,.7)",
                          margin: "3px 0",
                        }}
                      />
                      <div
                        style={{
                          ...
                          height: 14,
                          background:
                            "linear-gradient(to bottom,rgba(255,79,155,.45),rgba(123,79,255,.45))",
                        }}
                      />
                    </div>
                  )}
                  ...
                  {[
                    {
                      ...
                      fn: () => {
                        navigator.clipboard.writeText(
                          `🕳️ I went down a rabbit hole about "${result.topic}" and my mind is broken. Try yours! gorabbithole.com.au`,
                        );
                        setCopied(true);
                    ...
                    },
                    {
                      ...
                      fn: () =>
                        window.open(
                          `https://twitter.com/intent/tweet?text=${encodeURIComponent(`🕳️ Went down a rabbit hole about "${result.topic}" — completely mind-blown. Try yours: gorabbithole.com.au`)}`,
                        ),
                    },
                    {
                      icon: "💬",
                      ...
                      fn: () =>
                        window.open(
                          `https://wa.me/?text=${encodeURIComponent(`🕳️ This rabbit hole about "${result.topic}" is insane. Try your own at gorabbithole.com.au!`)}`,
                        ),
                    },
                  ].map((b) => (
                    <button
                ...
                <div style={{ display: "flex", gap: 10, marginBottom: 12 }}>
                  <button
                    ...
                    style={{
                      flex: 1,
                      padding: 16,
                      background: "linear-gradient(135deg,#7B4FFF,#FF4F9B)",
                      border: "none",
                      borderRadius: 16,
                      fontFamily: "'Syne',sans-serif",
                      fontSize: 13,
